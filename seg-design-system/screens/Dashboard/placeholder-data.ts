...
export const dashboardPlaceholderData = {
  ...
  recentActivity: [
    { id: '1', title: 'Completed: Airway Management Basics', meta: '2 hours ago' },
    { id: '2', title: 'Reviewed: Pediatric Dosage Chart', meta: 'Yesterday' },
    { id: '3', title: 'Started: Trauma Response Pathway', meta: '2 days ago' },
  ],
  notifications: [
