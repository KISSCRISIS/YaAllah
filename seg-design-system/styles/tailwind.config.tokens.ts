...
export const segTailwindTokens: Partial<Config['theme']> = {
  extend: {
    colors: {
      ...
      'seg-primary': 'rgb(var(--seg-primary) / <alpha-value>)',
      'seg-primary-strong': 'var(--seg-primary-strong)',
      'seg-emergency': 'rgb(var(--seg-emergency) / <alpha-value>)',
      'seg-text-primary': 'var(--seg-text-primary)',
      'seg-text-secondary': 'rgb(var(--seg-text-secondary) / <alpha-value>)',
      'seg-border': 'var(--seg-border)',
      'seg-warning': 'rgb(var(--seg-warning) / <alpha-value>)',
